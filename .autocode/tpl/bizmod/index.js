...
define(function(require) {
	...
	(function() {
		 ...
		 * STEP 1
		 */
		this.initModel = function($model, $watcher, $requester, $arg) {
		 ...
		 * STEP 2
		 */
		this.beforeRender = function($model, $watcher, $requester, $arg) {
		 ...
		 * STEP 3
		 */
		this.render = function($model, $watcher, $requester, $arg) {
		 ...
		 * STEP 4
		 */
		this.afterRender = function($model, $watcher, $requester, $arg) {
		 ...
		 * STEP 5
		 */
		this.bindEvent = function($model, $watcher, $requester, $arg) {
		 ...
		 * STEP 6
		 */
		this.beforeLeave = function($model, $watcher, $requester, $arg) {
